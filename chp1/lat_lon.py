...
print(Tx,Ty)
#平移变换中的Tx和Ty
#i[0][0]和i[0][1]代表姓名中间那个点，不过是人工确定的-_-
...
#用其中的一个点进行先缩放再平移的实验,观察坐标结果是否合理
#result1 的值为 [115.19743589743588, 31.92325581395349, 1.0] ，结果合理，后续还要将1去除

#-------------------------------------------------在jupyter notebook中写的,可能有些内容有重复----------------------------------------
import json
